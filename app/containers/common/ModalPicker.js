...
import styles from './ModalPickerStyle';
	...
	renderChildren() {
		...
		return (
			<View style={[styles.selectStyle, this.props.selectStyle]}>
				...
				<MIcons name="arrow-down-drop-circle-outline" size={20} style={{ color: '#CCCCCC' }} />
			</View>
		);
	}
	...
	render() {
		...
		return (
			<View style={{ ...this.props.style, flex: 1 }}>
				{dp}
				<Text style={styles.textLabel}>{this.state.label}</Text>
