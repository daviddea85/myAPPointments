...
class TreatmentsManagement extends Component {
	...
	createNewTreatment() {
		Actions.TreatmentInformation({ title: 'Treatment information', newtreatment: true, treatmentid: '' });
	}

	treatmentInfo(treatment) {
		Actions.TreatmentInformation({ title: 'Treatment information', newtreatment: true, treatmentid: treatment._id });
	}
